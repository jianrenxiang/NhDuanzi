...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // 1. 创建cell
    NHBaseTableViewCell *cell = [NHBaseTableViewCell cellWithTabelView:self.tableView];
...
- (UITableViewCell *)nh_cellAtIndexPath:(NSIndexPath *)indexPath { return [NHBaseTableViewCell cellWithTabelView:self.tableView]; }
