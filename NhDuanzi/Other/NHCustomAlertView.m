...
-(void)setup{
    ...
    style.lineSpacing=5;
    [attrbutedText addAttribute:NSParagraphStyleAttributeName value:style range:NSMakeRange(0, attrbutedText.length)];
    [attrbutedText addAttribute:NSFontAttributeName value:kFont(kScreenWidth>320?15:14) range:NSMakeRange(0, attrbutedText.length)];
    contentLabel.attributedText=attrbutedText;
